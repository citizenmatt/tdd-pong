...
public class PaddleTests
{
    ...
    public void PaddlesHaveSpriteRenderer()
    {
        ...
        for (int i = 0; i < paddles.Length; i++)
        {
            ...
            Assert.IsNotNull(paddles[i].gameObject.GetComponent<SpriteRenderer>(),
                "Paddle" + i + " has no SpriteRenderer");
        }
    }
    ...
    public void PaddlesHaveBoxCollider2D()
    {
        ...
        for (int i = 0; i < paddles.Length; i++)
        {
            ...
            Assert.IsNotNull(paddles[i].gameObject.GetComponent<BoxCollider2D>(),
                "Paddle" + i + " has no BoxCollider2D");
        }
    }
    ...
    public void PaddlesHaveCorrectSprite()
    {
        ...
        {
            paddles[i].GetComponent<Paddle>().RenderPaddle();
            Assert.AreEqual(AssetDatabase.LoadAssetAtPath("Assets/Sprites/whitesquare.png", typeof(Sprite)),
                paddles[i].gameObject.GetComponent<SpriteRenderer>().sprite);
        }
    }
